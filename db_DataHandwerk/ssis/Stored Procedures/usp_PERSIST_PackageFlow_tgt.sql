...
END
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = '86e4b435-213b-ec11-852c-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'ssis', @level1type = N'PROCEDURE', @level1name = N'usp_PERSIST_PackageFlow_tgt';
