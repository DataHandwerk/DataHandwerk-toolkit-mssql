...
As
Select
    T1.[referenced_usp_persistence_RepoObject_guid]  As [referenced_Procedure_RepoObject_guid]
  , T1.[referencing_usp_persistence_RepoObject_guid] As [referencing_Procedure_RepoObject_guid]
