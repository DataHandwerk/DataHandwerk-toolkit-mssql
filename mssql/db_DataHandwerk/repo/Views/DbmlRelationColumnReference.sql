CREATE VIEW [repo].[DbmlRelationColumnReference]
AS
--
SELECT DISTINCT
 --
...
GO
EXECUTE sp_addextendedproperty @name = N'RepoObjectColumn_guid', @value = '12df2fe1-ae7a-eb11-84e5-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'repo', @level1type = N'VIEW', @level1name = N'DbmlRelationColumnReference', @level2type = N'COLUMN', @level2name = N'DbmlRelationFK';


GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = '06df2fe1-ae7a-eb11-84e5-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'repo', @level1type = N'VIEW', @level1name = N'DbmlRelationColumnReference';
