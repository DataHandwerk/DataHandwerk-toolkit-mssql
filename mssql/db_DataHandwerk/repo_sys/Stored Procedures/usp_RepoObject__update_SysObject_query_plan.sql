...
FOR
    ...
    AND ([ro].[SysObject_query_plan] IS NULL
    ...
    BEGIN
                    ...
                    BEGIN
                        ...
                        BEGIN TRY
                            ...
                            FROM
                                 ...
                                 CROSS APPLY
                                 sys.dm_exec_sql_text(qry.sql_handle) AS txt
                                 CROSS APPLY
                                 sys.dm_exec_query_plan(qry.plan_handle) AS pln
        ...
        END
                ...
                EXEC repo.usp_ExecutionLog_insert
                   ...
                   , @event_info = @event_info
                   , @step_id = @step_id
                   , @step_name = 'UPDATE repo.RepoObject'
                   , @inserted = @rows
                   , @updated = NULL
                   , @deleted = NULL
                   , @info_01 = @RepoObject_guid
                   , @info_02 = @SysObject_query_sql
                   , @info_03 = @select_into_query
                   , @info_04 = NULL
                   , @info_05 = NULL
                   , @info_06 = NULL
                   , @info_07 = NULL
