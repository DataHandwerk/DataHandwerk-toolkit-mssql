...
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = 'ae90291c-9d61-eb11-84dc-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'sys_self', @level1type = N'PROCEDURE', @level1name = N'usp_dropextendedproperty_level_2';
