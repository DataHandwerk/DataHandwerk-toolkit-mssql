...
AS
	...
	*/
	...
	INNER JOIN (SELECT
		...
		AND [RepoObject_guid] IS NULL) AS [missing_guid]
	...
	*/
	...
	INSERT INTO repo.RepoObject ([RepoObject_guid]
	, [SysObject_id]
	, [SysObject_schema_name]
	, [SysObject_name]
	, [SysObject_type]
	...
	*/
	...
	INSERT INTO repo.RepoObject ([SysObject_id]
	, [RepoObject_schema_name]
	--, [RepoObject_name]
	, [RepoObject_type]
	, [SysObject_schema_name]
	...
	*/
	...
	INSERT INTO repo.RepoObjectProperty ([RepoObject_guid]
	, [property_name]
	, [property_value])
		SELECT DISTINCT
			[RepoObject_guid]
