CREATE TABLE [ssas].[TMSCHEMA_PERSPECTIVE_MEASURES] (
    ...
    CONSTRAINT [PK_TMSCHEMA_PERSPECTIVE_MEASURES] PRIMARY KEY CLUSTERED ([databasename] ASC, [ID] ASC) WITH (DATA_COMPRESSION = PAGE)
);
...
GO
EXECUTE sp_addextendedproperty @name = N'is_ssas', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES', @level2type = N'CONSTRAINT', @level2name = N'PK_TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'is_repo_managed', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES', @level2type = N'CONSTRAINT', @level2name = N'PK_TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'is_ssas', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES', @level2type = N'CONSTRAINT', @level2name = N'DF_TMSCHEMA_PERSPECTIVE_MEASURES_databasename';


GO
EXECUTE sp_addextendedproperty @name = N'is_repo_managed', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES', @level2type = N'CONSTRAINT', @level2name = N'DF_TMSCHEMA_PERSPECTIVE_MEASURES_databasename';


GO
EXECUTE sp_addextendedproperty @name = N'pk_IndexPatternColumnName', @value = N'databasename,ID', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'pk_IndexPatternColumnDatatype', @value = N'nvarchar(128),numeric(20, 0)', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'pk_index_guid', @value = N'B6E6A70A-8A06-EC11-8515-A81E8446D5B0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'is_ssas', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES';


GO
EXECUTE sp_addextendedproperty @name = N'is_repo_managed', @value = N'0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'TABLE', @level1name = N'TMSCHEMA_PERSPECTIVE_MEASURES';
