...
GO
EXECUTE sp_addextendedproperty @name = N'RepoObjectColumn_guid', @value = '906d05d0-0b08-ec11-8515-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'ssas', @level1type = N'VIEW', @level1name = N'IndexColumn_union', @level2type = N'COLUMN', @level2name = N'ExplicitName';
