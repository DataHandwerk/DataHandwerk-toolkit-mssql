...
--
--
EXEC [repo].[usp_RepoObjectSource_FirstResultSet] @execution_instance_guid = @execution_instance_guid
 , @ssis_execution_id = @ssis_execution_id
 , @sub_execution_id = @sub_execution_id
 , @parent_execution_log_id = @current_execution_log_id
...
EXEC [repo].[usp_RepoObject_update_SysObjectQueryPlan] @execution_instance_guid = @execution_instance_guid
 , @ssis_execution_id = @ssis_execution_id
 , @sub_execution_id = @sub_execution_id
 , @parent_execution_log_id = @current_execution_log_id
...
EXEC [repo].[usp_RepoObjectColumn_update_RepoObjectColumn_column_id] @execution_instance_guid = @execution_instance_guid
 , @ssis_execution_id = @ssis_execution_id
 , @sub_execution_id = @sub_execution_id
 , @parent_execution_log_id = @current_execution_log_id
...
EXEC repo.usp_ExecutionLog_insert @execution_instance_guid = @execution_instance_guid
 ...
 , @info_09 = NULL
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = 'bc90291c-9d61-eb11-84dc-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'repo', @level1type = N'PROCEDURE', @level1name = N'usp_aaa_all';
