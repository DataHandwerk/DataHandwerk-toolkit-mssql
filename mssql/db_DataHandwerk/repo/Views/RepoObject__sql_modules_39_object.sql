...
FROM
     ...
     LEFT OUTER JOIN
     repo.RepoObject__sql_modules_33_object_normalized AS T33_2
     ON T33_2.RepoObject_guid = T1.RepoObject_guid
        AND T33_2.normalized = 'GROUP BY'
     LEFT OUTER JOIN
     [repo].[RepoObject__sql_modules_26_object__union] AS T26
     ON T26.RepoObject_guid = T1.RepoObject_guid
     LEFT OUTER JOIN
     [repo].[RepoObject__sql_modules_27_object__GroupBy] AS T27
