...
AS
	...
	*/
	...
	INNER JOIN (SELECT
		...
		AND [RepoObjectColumn_guid] IS NULL) AS [missing_guid]
	...
	*/
	...
	INSERT INTO repo.RepoObjectColumn ([RepoObjectColumn_guid]
	, [RepoObject_guid]
	...
	*/
	...
	INSERT INTO repo.RepoObjectColumnProperty ([RepoObjectColumn_guid]
	, [property_name]
	, [property_value])
		SELECT DISTINCT
			[RepoObjectColumn_guid]
