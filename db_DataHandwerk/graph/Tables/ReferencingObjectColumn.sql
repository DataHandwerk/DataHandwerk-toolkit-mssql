...
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = '8eefc212-b764-eb11-84dd-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'graph', @level1type = N'TABLE', @level1name = N'ReferencingObjectColumn';
