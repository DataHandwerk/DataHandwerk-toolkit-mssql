...
From
    ...
    Left Outer Join
        repo.RepoObject_SqlModules_32_ObjectClass         As T32_1
            On
            T32_1.RepoObject_guid = T1.RepoObject_guid
            And T32_1.class       = 'IdentifierList'

    Left Outer Join
        repo.RepoObject_SqlModules_32_ObjectClass         As T32_2
            On
            T32_2.RepoObject_guid = T1.RepoObject_guid
            And T32_2.class       = 'WHERE'

    Left Outer Join
        repo.RepoObject_SqlModules_33_ObjectNormalized    As T33_1
            On
            T33_1.RepoObject_guid = T1.RepoObject_guid
            And T33_1.normalized  = 'FROM'

    Left Outer Join
        repo.RepoObject_SqlModules_33_ObjectNormalized    As T33_2
            On
            T33_2.RepoObject_guid = T1.RepoObject_guid
            And T33_2.normalized  = 'GROUP BY'

    Left Outer Join
        repo.RepoObject_SqlModules_29_1_object_is_union   As T26
            On
            T26.RepoObject_guid   = T1.RepoObject_guid

    Left Outer Join
        repo.RepoObject_SqlModules_29_2_object_is_GroupBy As T27
            On
