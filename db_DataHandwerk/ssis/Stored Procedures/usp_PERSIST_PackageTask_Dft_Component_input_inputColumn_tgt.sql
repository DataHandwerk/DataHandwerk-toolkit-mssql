...
END
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = '24950354-dc3f-ec11-852d-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'ssis', @level1type = N'PROCEDURE', @level1name = N'usp_PERSIST_PackageTask_Dft_Component_input_inputColumn_tgt';
