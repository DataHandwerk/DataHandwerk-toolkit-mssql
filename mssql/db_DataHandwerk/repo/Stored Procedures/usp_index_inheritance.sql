...
AS
	...
	WHERE NOT [referenced_index_guid] IS NULL
		...
		OR [referenced_index_guid] NOT IN (SELECT
	...
	INSERT INTO repo.[Index_virtual] ([parent_RepoObject_guid]
	...
	INSERT INTO repo.[IndexColumn_virtual] ([Index_guid]
	, [index_column_id]
	, [is_descending_key]
	...
	LEFT JOIN (SELECT
		...
		AND [RowNumber_PkPerParentObject] = 1) [pk]
