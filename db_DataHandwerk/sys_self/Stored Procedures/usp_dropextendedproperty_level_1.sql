...
GO
EXECUTE sp_addextendedproperty @name = N'is_ssas', @value = N'0', @level0type = N'SCHEMA', @level0name = N'sys_self', @level1type = N'PROCEDURE', @level1name = N'usp_dropextendedproperty_level_1';


GO
EXECUTE sp_addextendedproperty @name = N'is_repo_managed', @value = N'0', @level0type = N'SCHEMA', @level0name = N'sys_self', @level1type = N'PROCEDURE', @level1name = N'usp_dropextendedproperty_level_1';
