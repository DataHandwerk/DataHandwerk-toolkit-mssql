...
End;
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = 'e735c571-8103-ec11-8513-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'reference', @level1type = N'PROCEDURE', @level1name = N'usp_external_object_set';
