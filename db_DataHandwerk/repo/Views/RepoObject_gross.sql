...
Select
  ...
  , AntoraModulName                         = AntoraModulName.Parameter_value_result
From
    ...
    Cross Join config.ftv_get_parameter_value ( 'AntoraModulName', '' ) As AntoraModulName
Go
...
GO
EXECUTE sp_addextendedproperty @name = N'RepoObjectColumn_guid', @value = '3708fcfd-b004-ec11-8514-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'repo', @level1type = N'VIEW', @level1name = N'RepoObject_gross', @level2type = N'COLUMN', @level2name = N'AntoraModulName';
