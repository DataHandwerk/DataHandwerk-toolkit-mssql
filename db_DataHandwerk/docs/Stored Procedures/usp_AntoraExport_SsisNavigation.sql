...
END
GO
EXECUTE sp_addextendedproperty @name = N'RepoObject_guid', @value = '8c9a07f7-c23c-ec11-852d-a81e8446d5b0', @level0type = N'SCHEMA', @level0name = N'docs', @level1type = N'PROCEDURE', @level1name = N'usp_AntoraExport_SsisNavigation';
