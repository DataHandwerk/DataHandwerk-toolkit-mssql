...
AS
	...
	BEGIN
		...
		BEGIN
			...
			SET @info_01_message = CONCAT(@source_RepoObject_guid, ': Source object is missing in [repo].[RepoObject] or type is not U or V')
		...
		SET @persistence_table_name = ISNULL(@persistence_table_name, CONCAT(@source_table_name, @persistence_name_suffix))
		...
		INSERT INTO repo.RepoObject ([RepoObject_schema_name]
		, [RepoObject_name]
		, [RepoObject_type]
		...
		INTO @ids
			VALUES (@persistence_schema_name, @persistence_table_name, 'U', @persistence_schema_name, 1)

		SET @persistence_RepoObject_guid = (SELECT
				[guid]
			FROM @ids)
	...
	IF @source_RepoObject_guid IS NULL
		...
		THROW 51011, 'source and persistence not matching, still: @source_RepoObject_guid is null OR @persistence_RepoObject_guid is null', 1;
	...
	INSERT INTO [repo].[RepoObject_persistence] ([target_RepoObject_guid]
	, [source_RepoObject_guid])
		SELECT
	...
	*/
	...
	INSERT INTO [repo].[RepoObjectColumn] ([RepoObject_guid]
