...
GO
EXECUTE sp_addextendedproperty @name = N'ReferencedObjectList', @value = N'[repo].[type]', @level0type = N'SCHEMA', @level0name = N'config', @level1type = N'VIEW', @level1name = N'type_level1type_level2type';
